...
trait BaseTest
{
    ...
    public function testHeaders()
    {
        ...
        $this->assertSame('value1', $response['headers']['key1']);
        $this->assertSame('value2', $response['headers']['key2']);
    ...
    public function testHumans()
    {
        ...
        $this->assertSame('humans.txt', $response['body']);
        $this->assertSame(200, $response['headers']['status-code']);
        $this->assertSame('Utopia', $response['headers']['x-engine']);
    }
    ...
    public function testCookie()
    {
        ...
        $response = $this->client->call(Client::METHOD_GET, '/cookies', [ 'Cookie' => $cookie ]);
        $this->assertSame(200, $response['headers']['status-code']);
        $this->assertSame('cookie1=value1; cookie2=value2', $response['body']);
        ...
        $response = $this->client->call(Client::METHOD_GET, '/cookies', [ 'Cookie' => $cookie ]);
        $this->assertSame(200, $response['headers']['status-code']);
        $this->assertSame('cookie1=v1; Cookie1=v2', $response['body']);
    }
